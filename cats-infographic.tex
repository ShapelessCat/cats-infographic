...
% Text Node
\draw (109,1300) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{765.65pt}\setlength\topsep{0pt}
\begin{center}
cats-infographic 2.4 for cats 2.10.0, cats-effect 3.5.4, and cats-mtl 1.4.0 • Source available at github.com/ShapelessCat/cats-infographic • Shareable under CC-BY-SA 4.0
\end{center}
